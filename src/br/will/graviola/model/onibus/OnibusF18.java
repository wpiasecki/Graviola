	  ...
	  public class OnibusF18 {
		  ...
		  ponto2.setNome("T.FAZENDA/SUMITOMO+MATE LEAO");
		  ponto2.setTipoDia(TipoDia.getTipoDia("DIA_UTIL"));
		  ponto2.setValidoAPartirDe("26/11/2012");
		  onibus.getPontos().addElement(ponto2);
		  ponto2.getHorarios().addElement("06:40");
		  ponto2.getHorarios().addElement("17:05");
		  ponto2.getHorarios().addElement("17:25");
		  Ponto ponto3 = new Ponto();
		  ponto3.setNome("T.FAZENDA/PQ.INDL.+MATE LEAO");
		  ponto3.setTipoDia(TipoDia.getTipoDia("DIA_UTIL"));
		  ponto3.setValidoAPartirDe("26/11/2012");
		  ...
		  ponto4.setNome("T.FAZENDA/PQ.INDUSTRIAL");
		  ponto4.setTipoDia(TipoDia.getTipoDia("SABADO"));
		  ponto4.setValidoAPartirDe("02/02/2008");
		  ...
		  ponto5.setNome("T.FAZENDA/PQ.INDUSTRIAL");
		  ...
		  ponto6.setNome("ANTEX (CHEGADA)");
		  ponto6.setTipoDia(TipoDia.getTipoDia("DOMINGO"));
		  ponto6.setValidoAPartirDe("03/02/2008");
		  ...
		  ponto7.setNome("ANTEX (SAIDA)");
		  ponto7.setTipoDia(TipoDia.getTipoDia("DOMINGO"));
		  ponto7.setValidoAPartirDe("03/02/2008");
