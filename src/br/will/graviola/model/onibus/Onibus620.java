	...
	public class Onibus620 {
		...
		ponto0.setValidoAPartirDe("14/08/2012");
		...
		ponto1.setValidoAPartirDe("14/08/2012");
		onibus.getPontos().addElement(ponto1);
		Ponto ponto2 = new Ponto();
		ponto2.setNome("R. SEN.ACCIOLY FILHO");
		ponto2.setTipoDia(TipoDia.getTipoDia("DIA_UTIL"));
		ponto2.setValidoAPartirDe("14/08/2012");
		...
		ponto3.setValidoAPartirDe("14/08/2012");
		...
		ponto4.setValidoAPartirDe("14/08/2012");
